...
//        super.requestCurrentTwitterPerson(onRequestTwitterPersonCompleteListener);
    ...
    private class RequestGetPersonAsyncTask extends SocialNetworkAsyncTask {
        ...
        public static final String TWITTER_USER = "RequestGetPersonAsyncTask.TWITTER_USER";
        private static final String RESULT_IS_CURRENT_PERSON = "RequestPersonAsyncTask.RESULT_IS_CURRENT_PERSON";
		private static final String RESULT_IS_TWITTER_PERSON = "RequestPersonAsyncTask.RESULT_IS_TWITTER_PERSON";
        ...
        private static final String RESULT_CREATED_DATE = "RequestPersonAsyncTask.RESULT_CREATED_DATE";
		private static final String RESULT_DESCRIPTION = "RequestPersonAsyncTask.RESULT_DESCRIPTION";
		private static final String RESULT_FAVORITES_COUNT = "RequestPersonAsyncTask.RESULT_FAVORITES_COUNT";
		private static final String RESULT_FOLLOWERS_COUNT = "RequestPersonAsyncTask.RESULT_FOLLOWERS_COUNT";
		private static final String RESULT_FRIENDS_COUNT = "RequestPersonAsyncTask.RESULT_FRIENDS_COUNT";
		private static final String RESULT_LANG = "RequestPersonAsyncTask.RESULT_LANG";
		private static final String RESULT_LOCATION = "RequestPersonAsyncTask.RESULT_LOCATION";
		private static final String RESULT_SCREEN_NAME = "RequestPersonAsyncTask.RESULT_SCREEN_NAME";
		private static final String RESULT_STATUS = "RequestPersonAsyncTask.RESULT_STATUS";
		private static final String RESULT_TIMEZONE = "RequestPersonAsyncTask.RESULT_TIMEZONE";
		private static final String RESULT_URL = "RequestPersonAsyncTask.RESULT_URL";
		private static final String RESULT_IS_TRANSLATOR = "RequestPersonAsyncTask.RESULT_IS_TRANSLATOR";
		private static final String RESULT_IS_VERIFIED = "RequestPersonAsyncTask.RESULT_IS_VERIFIED";
        ...
        protected Bundle doInBackground(Bundle... params) {
            ...
            if (args.containsKey(PARAM_USER_ID)) {
				...
				if(args.containsKey(TWITTER_USER)) result.putBoolean(RESULT_IS_TWITTER_PERSON, true);
            }
            ...
            try {
				...
				result.putLong(RESULT_CREATED_DATE, user.getCreatedAt().getTime());
				result.putString(RESULT_DESCRIPTION, user.getDescription());
				result.putInt(RESULT_FAVORITES_COUNT, user.getFavouritesCount());
				result.putInt(RESULT_FOLLOWERS_COUNT, user.getFollowersCount());
				result.putInt(RESULT_FRIENDS_COUNT, user.getFriendsCount());
				result.putString(RESULT_LANG, user.getLang());
				result.putString(RESULT_LOCATION, user.getLocation());
				result.putString(RESULT_SCREEN_NAME, user.getScreenName());
				result.putString(RESULT_STATUS, user.getStatus().toString());
				result.putString(RESULT_TIMEZONE, user.getTimeZone());
				result.putString(RESULT_URL, user.getURL());
				result.putBoolean(RESULT_IS_TRANSLATOR, user.isTranslator());
				result.putBoolean(RESULT_IS_VERIFIED, user.isVerified());
            } catch (TwitterException e) {
                Log.e(TAG, "ERROR", e);
                result.putString(RESULT_ERROR, e.getMessage());
            }
        ...
        protected void onPostExecute(Bundle result) {
            if (result.getBoolean(RESULT_IS_CURRENT_PERSON)) {
				...
				if(result.getBoolean(RESULT_IS_TWITTER_PERSON)){
					...
					twitterPerson.name = result.getString(RESULT_NAME);
					twitterPerson.avatarURL = result.getString(RESULT_AVATAR_URL);
					twitterPerson.createdDate = result.getLong(RESULT_CREATED_DATE);
					twitterPerson.description = result.getString(RESULT_DESCRIPTION);
					twitterPerson.favoritesCount = result.getInt(RESULT_FAVORITES_COUNT);
					twitterPerson.followersCount = result.getInt(RESULT_FOLLOWERS_COUNT);
					twitterPerson.friendsCount = result.getInt(RESULT_FRIENDS_COUNT);
					twitterPerson.lang = result.getString(RESULT_LANG);
					twitterPerson.location = result.getString(RESULT_LOCATION);
					twitterPerson.screenName = result.getString(RESULT_SCREEN_NAME);
					twitterPerson.status = result.getString(RESULT_STATUS);
					twitterPerson.timezone = result.getString(RESULT_TIMEZONE);
					twitterPerson.url = result.getString(RESULT_URL);
